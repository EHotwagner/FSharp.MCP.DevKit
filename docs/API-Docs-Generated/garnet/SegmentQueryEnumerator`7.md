# SegmentQueryEnumerator`7 Struct
...
**Signature:** `System.ValueTuple`6[s1,s2,s3,s4,s5,s6] get_Item(Int32)`
...
**Signature:** `System.ValueTuple`7[Garnet.Composition.SegmentDescriptor`1[k],Garnet.Composition.SegmentData`1[s1],Garnet.Composition.SegmentData`1[s2],Garnet.Composition.SegmentData`1[s3],Garnet.Composition.SegmentData`1[s4],Garnet.Composition.SegmentData`1[s5],Garnet.Composition.SegmentData`1[s6]] get_Current()`
...
**Signature:** `Boolean Equals(Garnet.Composition.SegmentQueryEnumerator`7[k,s1,s2,s3,s4,s5,s6])`
**Return Type:** `Boolean`

**Parameters:**
| Parameter | Type | Optional | Default | Description |
|-----------|------|----------|---------|-------------|
| `obj` | `SegmentQueryEnumerator`7` | No | `` |  |
