# SegmentQueryEnumerator`5 Struct
...
**Signature:** `System.ValueTuple`4[s1,s2,s3,s4] get_Item(Int32)`
...
**Signature:** `System.ValueTuple`5[Garnet.Composition.SegmentDescriptor`1[k],Garnet.Composition.SegmentData`1[s1],Garnet.Composition.SegmentData`1[s2],Garnet.Composition.SegmentData`1[s3],Garnet.Composition.SegmentData`1[s4]] get_Current()`
...
**Signature:** `Boolean Equals(Garnet.Composition.SegmentQueryEnumerator`5[k,s1,s2,s3,s4])`
**Return Type:** `Boolean`

**Parameters:**
| Parameter | Type | Optional | Default | Description |
|-----------|------|----------|---------|-------------|
| `obj` | `SegmentQueryEnumerator`5` | No | `` |  |
