# ComponentBatchEnumerator`2 Struct
...
**Signature:** `Int32 CompareTo(Garnet.Composition.ComponentBatchEnumerator`2[k,s1])`
**Return Type:** `Int32`

**Parameters:**
| Parameter | Type | Optional | Default | Description |
|-----------|------|----------|---------|-------------|
| `obj` | `ComponentBatchEnumerator`2` | No | `` |  |
...
**Signature:** `Boolean Equals(Garnet.Composition.ComponentBatchEnumerator`2[k,s1])`
**Return Type:** `Boolean`
